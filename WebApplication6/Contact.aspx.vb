Public Class Contact
    ...
    Private Sub algo()
        ...
        For Each a In _amigos
            ...
            amigos.Text &= String.Format("<tr><td><a href=""#""><img src=""https://graph.facebook.com/{0}/picture?type=square""></a></td><td><a href=""#"">{2} {3} </a></td></tr>", a.uid, a.email, a.first_name, a.last_name)
