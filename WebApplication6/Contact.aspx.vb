    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
            ...
            For Each a In _amigos
                ...
                amigos.Text &= String.Format("<tr><td><img src=""https://graph.facebook.com/{0}/picture?type=square""></td><td><a href=""HistorialDeCarreras.aspx?IdResultado={1}"">{2} {3} </a></td></tr>", a.uid, a.email, a.first_name, a.last_name)
