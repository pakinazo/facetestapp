...
Public Class _Default
    ...
    Private Sub getUserData(ByVal code As String)
        ...
        Dim fbURL As String = String.Format("https://graph.facebook.com/oauth/access_token?client_id={0}&redirect_uri={1}&client_secret={2}&code={3}", "294444543985836", MyURL, "0757f6a496872d0d3c02087c183d0c2f", code)
        ...
        Try
            My.Computer.FileSystem.WriteAllText("c://canvas/registroFB.txt", usrRest.ToString, True)
